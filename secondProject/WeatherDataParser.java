...
public class WeatherDataParser {
    ...
    private static final Set<String> ULTRA_SRT_NCST_CATEGORIES = Set.of("T1H", "PTY", "WSD"); // 초단기실황
    private static final Set<String> ULTRA_SRT_FCST_CATEGORIES = Set.of("T1H", "PTY"); // 초단기예보
    private static final Set<String> VILAGE_FCST_CATEGORIES = Set.of("TMN", "TMX", "PTY"); // 단기예보
